...
if grep HAVE_NTRU "cyassl/options.h"; then
    ...
    if grep HAVE_NTRU "cyassl/options.h"; then
        ...
        echo "ntru-cert.pem, ntru-cert.der, and ntru-key.raw have been updated"
        echo ""        
        ...
        echo ""
        echo "If you are not using ntru then you can ignore this message,"
        echo "you're all set."
        echo ""
        echo "Otherwise, please check your ntru install location."
