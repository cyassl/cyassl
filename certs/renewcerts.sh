...
if grep HAVE_NTRU "cyassl/options.h"; then
    ...
    if grep HAVE_NTRU "cyassl/options.h"; then
        ...
        echo ""
        echo "The purpose of this script is to update all certificates, please"
        echo "install ntru in the default location..."
        echo ""
        echo "run the following from your home directory (cd ~)"
        echo "git clone https://github.com/NTRUOpenSourceProject/NTRUEncrypt"
